...
SECRET_KEY = 'django-insecure-zs^$nhgfoeyu4h1g2_=i5j4uvel0crjeqcjga5h%bsv7gxfc$^'
...
LOGIN_REDIRECT_URL = 'profile'  # URL, на который перенаправляется пользователь после входа
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], #  здесь указывается путь к директории шаблона
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
